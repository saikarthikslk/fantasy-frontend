const API_BASE = import.meta.env.VITE_API_BASE ?? 'https://c8fd-123-201-171-91.ngrok-free.app'

/** Spring Boot serves OAuth at this origin; not proxied (browser must hit 8080 for redirects). */
export const BACKEND_ORIGIN =
  import.meta.env.VITE_BACKEND_ORIGIN ?? 'https://c8fd-123-201-171-91.ngrok-free.app'
